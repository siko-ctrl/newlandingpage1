            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        <a href="https://twitter.com/salviumprotocol" target="_blank" class="text-[#40E0D0] hover:text-[#40E0D0]/80">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="https://twitter.com/salviumprotocol" target="_blank" class="text-gray-400 hover:text-[#40E0D0] transition-colors">Twitter</a></li>
